 ...
 */
final class Version20240216133259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, immat VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, couleur VARCHAR(255) NOT NULL, photo1 VARCHAR(255) NOT NULL, photo2 VARCHAR(255) NOT NULL, photo3 VARCHAR(255) DEFAULT NULL, INDEX IDX_E9E2810FC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
